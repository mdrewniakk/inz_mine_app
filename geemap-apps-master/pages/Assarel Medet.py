...
images_bga = years.map(best_image)
images_bga = images_bga.add(latest_image())
count = images_bga.size().getInfo()
dataset = calc_indices(images_bga, assarel)
